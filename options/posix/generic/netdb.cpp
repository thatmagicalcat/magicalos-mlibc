    ...
    requires(std::is_invocable_r_v<bool, F, frg::string_view, int>)
{
	...
	while (true) {
		...
		if (function(protoName, *protoNumRes)) {
			...
			ent.p_aliases =
			    reinterpret_cast<char **>(malloc(sizeof(char *) * (aliases.size() + 1)));
...
struct hostent *gethostent(void) { return nullptr; }
...
struct netent *getnetbyaddr(uint32_t, int) { return nullptr; }

struct netent *getnetbyname(const char *) { return nullptr; }

struct netent *getnetent(void) { return nullptr; }
...
struct hostent *gethostbyname2(const char *, int) { return nullptr; }
...
struct protoent *getprotobynumber(int num) {
	...
	auto success =
	    findProto(protoentStorage, [num](auto, auto protoNum) { return num == protoNum; });
...
struct protoent *getprotoent(void) {
	...
	auto success = findProto(protoentStorage, [](auto, auto) { return true; });
...
struct servent *getservent(void) { return nullptr; }

void sethostent(int) {}

void setnetent(int) {}

void setprotoent(int stayopen) { openProtoFd(stayopen); }

void setservent(int) {}

const char *hstrerror(int) { return ""; }
